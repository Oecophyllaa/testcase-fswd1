            ...
            <form action="{{ route('admin.karyawan.store') }}" method="POST">
              ...
              <div class="row mb-4">
                <div class="col-lg-6 col-12">
                  ...
                  <input type="text" name="nomor_induk" id="nomor_induk" value="{{ old('nomor_induk') }}" placeholder="-----"
              ...
              <div class="row mb-4">
                <div class="col-lg-6 col-12">
                  ...
                  <input type="text" name="nama" id="nama" value="{{ old('nama') }}" placeholder="----&nbsp;----"
                ...
                <div class="col-lg-6 col-12">
                  ...
                  <input type="date" name="tgl_bergabung" id="tgl_bergabung" value="{{ old('tgl_bergabung') }}"
